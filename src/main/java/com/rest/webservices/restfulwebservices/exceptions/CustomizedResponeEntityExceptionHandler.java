...
public class CustomizedResponeEntityExceptionHandler  extends  ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleAllExceptions(Exception ex, WebRequest request) {
		...
		ExceptionHandlingResponse exceptionResponse = new ExceptionHandlingResponse(new Date(), ex.getMessage(), 
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
		...
		ExceptionHandlingResponse exceptionResponse = new ExceptionHandlingResponse(new Date(), "Validation Failed", 
